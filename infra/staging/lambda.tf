...
moved {
  from = module.stat_updater_lambda
  to   = module.updater.module.stat_updater_lambda
}

moved {
  from = aws_iam_role_policy.s3_policy
  to   = module.updater.aws_iam_role_policy.s3_policy
}
